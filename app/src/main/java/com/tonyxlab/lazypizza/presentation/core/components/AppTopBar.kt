...
fun AppTopBar(
    ...
    Row(
        ...
        Row(
            ...
            Image(modifier = Modifier.size(MaterialTheme.spacing.spaceTen * 2),
        ...
        Row(
            ...
            Icon(modifier = Modifier.size(MaterialTheme.spacing.spaceMedium),
...
private fun AppTopBar_Preview() {
    ...
    LazyPizzaTheme {
        ...
        Column(
            ...
            AppTopBar(phoneNumber = "0723 445 813", onCallClick = {})
